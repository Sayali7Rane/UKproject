...
<h1 style="text-align:center ;color:#3d3d5c; margin-bottom: 70px">Login Form </h1>
	...
	<table align="center" >
		...
		<tr>
			...
			<td>
				<input type="submit" style="color:white; background-color:#0000cc;margin-top:5px;" value="Login" >
			</td>
		</tr>
	</table>
	</spr:form>
